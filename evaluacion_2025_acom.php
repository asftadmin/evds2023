...
$evaluacion= $evaluacionClass->listar_subevaluacion_veinticinco();
$evaluacion_coe= $evaluacionClass->listar_coevaluacion_veinticinco();
$evaluacion_auto= $evaluacionClass->listar_autoevaluacion_veinticinco();
...
foreach ($evaluacion as $operacion) {
    $formulario = $operacion['empl_eval'];
...
// Datos de ejemplo
$productividad = [number_format($productividad1, 2),
...
// Datos de ejemplo
$laboral = [number_format($conducta1,2),
...
// Datos de ejemplo
$actitud = [number_format($actitud1,2),
...
// Datos de ejemplo
$liderazgo = [number_format($liderazgo1, 2),
...
$pdf->Cell(80, 8, utf8_decode('AUTOEVALUACION'), 1, 0, 'C');
$pdf->Cell(50, 8, utf8_decode('5%'), 1, 0, 'C');
$pdf->Cell(46, 8, number_format($subtotalAutoevalcion,2), 1, 1, 'C');
$pdf->Cell(20, 8, utf8_decode('B'), 1, 0, 'C');
$pdf->Cell(80, 8, utf8_decode('COEVALUACION'), 1, 0, 'C');
$pdf->Cell(50, 8, utf8_decode('5%'), 1, 0, 'C');
$pdf->Cell(46, 8, utf8_decode($subtotalCoevaluacion), 1, 1, 'C');
$pdf->Cell(20, 8, utf8_decode('C'), 1, 0, 'C');
$pdf->Cell(80, 8, utf8_decode('SUBEVALUACION'), 1, 0, 'C');
$pdf->Cell(50, 8, utf8_decode('90%'), 1, 0, 'C');
