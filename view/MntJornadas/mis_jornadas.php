                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="jornada-acciones mb-2">
                                <button type="button" class="btn btn-success" id="btn-enviar-seleccionadas" disabled>
                                    <i class="fas fa-paper-plane mr-1"></i>Enviar seleccionadas
                                </button>
                                <span id="conteo-seleccionadas" class="text-muted" aria-live="polite">0
                                    seleccionadas</span>
                            </div>
                            <p class="small text-muted">
                                La casilla del encabezado selecciona los borradores de todas las páginas del resultado
                                filtrado.
                                Al cambiar los filtros se restablece la selección. Máximo 500 por envío.
                            </p>
                            <div id="resultado-envio" class="alert d-none" role="status"></div>

                            <div class="table-responsive">
                                <table id="tabla-jornadas" class="table table-bordered table-striped table-hover"
                                    width="100%">
                                    <thead>
                                        <tr>
                                            <th>
