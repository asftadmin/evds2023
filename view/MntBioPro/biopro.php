                                ...
                                <div class="card-body">
                                    <div id="balance-kpi-wrap" style="display:none;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="small-box mb-0 bg-secondary" id="saldo-horas-efectivas-box" style="min-height: 64px;">
                                                    <div class="inner py-2">
                                                        <h3 id="saldo-horas-efectivas" class="mb-1">0:00</h3>
                                                        <p class="mb-0">Saldo horas</p>
                                                        <small id="saldo-horas-efectivas-label">Sin diferencia</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
