<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <div class="dropdown dropdown-typical"><span class="fas fa-user-alt mr-2" style="color:#17a2b8"></span> <span
                    class="lblcontactonomx"> <?php echo $_SESSION["nomb_empl"] ?></span></div>
        </li>
    </ul>
