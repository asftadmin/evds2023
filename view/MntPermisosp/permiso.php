...
if (isset($_SESSION["user_id"])) {
    ...
    $permiso_token = bin2hex(random_bytes(16));
    $_SESSION['permiso_token'] = $permiso_token;
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form_permiso">
                                ...
                                <input type="hidden" id="permiso_token" name="permiso_token" value="<?= $permiso_token ?>">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Cargo</label>
                                        <input type="text" id="empleado_cargo" name="empleado_cargo" class="form-control"
                                            readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group date" id="reservationdate_fecha"
                                            ...
                                            <input type="text" class="form-control " data-target="#reservationdate_fecha"
                                                name="fecha_permiso" id="fecha_permiso" required />
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="timepicker_salida" id="timepicker_salida"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="timepicker_entrada" id="timepicker_entrada"
                                                class="form-control" autocomplete="off">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="far fa-clock"></i></span>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="permiso_motivo" name="permiso_motivo" class="form-control"
                                        required></select>
                                </div>

                                <div class="form-group">
                                    <label>Justificación</label>
                                    <textarea name="permiso_detalle" id="permiso_detalle" rows="4"
                                ...
                                <div class="form-group">
                                    <img id="previewFirma" src="" alt="Firma no registrada" width="200"
                                ...
                                <button type="button" id="btnRegistrarFirma" class="btn btn-info btn-block">Registrar
                                    Firma</button>
                                <button type="sumbit" id="btnGuardar" class="btn btn-dark btn-block">Registrar
                                    Permiso</button>
