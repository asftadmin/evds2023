<!-- Modal -->
<div class="modal fade" id="modalFirma" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <canvas id="canvasFirma" width="400" height="200" style="border:1px solid #000; border-radius:8px; touch-action:none;"></canvas><br>
