                                ...
                                <div class="card-body p-0">
                                    <div class="inbox-wrapper">
                                        ...
                                        <div class="inbox-lista bg-white">
                                            ...
                                            <div class="p-2 border-bottom">
                                                ...
                                                <div class="form-group mb-2">
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="filtro_fechas" placeholder="Rango de fechas…">
                                                </div>
                                            ...
                                            <!-- Lista -->
                                            <div class="lista-body" id="lista-solicitudes">
                                        ...
                                        <!-- ══ PANEL DETALLE ══ -->
                                        <div class="inbox-detalle" id="panel-detalle">
                                            <div class="card card-outline card-dark mb-0">
                                                ...
                                                <div class="card-header d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h5 class="card-title mb-0">
                                                            <i class="fas fa-file-alt mr-2 text-dark"></i>Solicitud de
                                                            Permiso
                                                        </h5>
                                                        <small class="text-muted">Solicitado el 14/03/2026 08:32
                                                            a.m.</small>
                                                    </div>
                                                    <span class="badge-pendiente">Pendiente</span>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-4">
                                                            <small
                                                                class="text-uppercase text-muted font-weight-bold d-block"
                                                                style="font-size:10px; letter-spacing:0.5px;">
                                                                <i class="fas fa-user mr-1"></i>Empleado
                                                            </small>
                                                            <span class="font-weight-bold">CRISTIAN ARCINIEGAS
                                                                PORTILLA</span>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <small
                                                    ...
                                                    <div class="justif-box mb-3">
                                                        Cita médica programada con especialista en el Hospital Universitario
                                                        Erasmo Meoz.
                                                ...
                                                <div class="card-footer d-flex align-items-center" style="gap:10px;">
                                                    ...
                                                    <small class="text-muted ml-auto">
                                                        <i class="fas fa-info-circle mr-1"></i>Al aprobar se solicitará su
                                                        firma digital
                                                    </small>
                                                </div>
